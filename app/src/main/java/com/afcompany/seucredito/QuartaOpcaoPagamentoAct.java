...
public class QuartaOpcaoPagamentoAct extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quarta_opcao_pagamento);

        edtParcelas = findViewById(R.id.edt_view4_parcelas);

        txtOpcao1 = findViewById(R.id.txt_view4_opcao1);
        txtOpcao2 = findViewById(R.id.txt_view4_opcao2);
        txtOpcao3 = findViewById(R.id.txt_view4_opcao3);
        txtOpcao4 = findViewById(R.id.txt_view4_opcao4);
        ...
        ImageButton btnVoltar = findViewById(R.id.btn_voltar4);
        btnVoltar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(QuartaOpcaoPagamentoAct.this, SolicitacaoActivity.class);
                startActivity(in);
            }
        });

        btnOpcoesParcelas = findViewById(R.id.btn_opcoes_pagamento_view4);
        btnOpcoesParcelas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (edtParcelas.getText().toString().isEmpty()) {
                    Toast.makeText(QuartaOpcaoPagamentoAct.this, R.string.error_msg3, LENGTH_SHORT).show();
                    return;
                }
                ...
                if (parcelas >= 1 && parcelas <= 12) {
                    if (parcelas == 1) {
                        ...
                        txtOpcao1.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent in = new Intent(QuartaOpcaoPagamentoAct.this, DadosDetalhadosAct.class);
                                startActivity(in);
