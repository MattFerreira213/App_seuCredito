    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnVoltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(PrimeiraOpcaoPagamentoAct.this, SolicitacaoActivity.class);
                startActivity(in);
            }
        });
                ...
                if (parcelas >= 1 && parcelas <= 12) {
                    if (parcelas == 1) {
                        ...
                        txtOpcao1.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent in = new Intent(PrimeiraOpcaoPagamentoAct.this, DadosDetalhadosAct.class);
                                startActivity(in);
